...
export class AnalyticsComponent implements OnInit {
  ...
  private metricsDatasets: {
    ...
    '7days': {
      ...
      trafficSources: [
        ...
        {
          name: 'Social Media (Reels/Carousels)',
          percentage: 30,
          visitors: '4,140',
          color: '#0ea5e9'
        },
      ...
      funnelSteps: [
        ...
        {
          stage: 'Signed Up for Free Trial',
          count: '3,720',
          conversion: '27.0%',
          width: '78%'
        },
        ...
        {
          stage: 'Converted to Paid Enterprise',
          count: '540',
          conversion: '3.9%',
          width: '27%'
        }
    ...
    this.filterForm
      ...
      .subscribe(
        (selectedRange: string) => {
          ...
          if (
            this.metricsDatasets[selectedRange]
          ) {
  ...
  onExportReport(): void {
    ...
    this.successMessage =
      'ApexUI Studio Analytics report exported successfully as CSV/PDF!';
